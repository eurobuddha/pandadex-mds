...
zip -q "${OUT}" index.html style.css fonts.css parity.css inter_var.ttf jetbrains_mono_var.ttf mds.js decimal.js covenant.js book.js sweep.js txn.js tape.js maker.js price.js verifier.js pending.js stats.js service.js favicon.png
